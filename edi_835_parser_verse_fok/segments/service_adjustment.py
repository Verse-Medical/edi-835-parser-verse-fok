...
from edi_835_parser_verse_fok.elements.adjustment_group_code import AdjustmentGroupCode
from edi_835_parser_verse_fok.elements.adjustment_reason_code import AdjustmentReasonCode
